export default function Input({ placeholder, label, icon, error, value, onChange }) {
    return (
        <div className="">
            <div className="flex justify-between items-center mb-2">
                <label htmlFor={label} className="text-dark-grayish-cyan block">{label}</label>
                {error ?
